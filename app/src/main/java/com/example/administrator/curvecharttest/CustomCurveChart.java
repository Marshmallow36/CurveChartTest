...
public class CustomCurveChart extends View {
        ...
        public CustomCurveChart(Context context, String[] xLabel, String[] yLabel,
                                List<double[]> dataList, List<Integer> colorList, boolean showValue) {
            super(context);
            this.xLabel = xLabel;
            this.yLabel = yLabel;
        ...
        public void init() {
            ...
            paintToday = new Paint();
            paintToday.setStyle(Paint.Style.STROKE);
            paintToday.setAntiAlias(true);
            paintToday.setDither(true);
            paintToday.setColor(ContextCompat.getColor(getContext(), R.color.color25));
            paintToday.setStrokeWidth(1);
     ...
     */
         ...
         * 绘制曲线
         */
        private void drawCurve(Canvas canvas, Paint paint, double[] data, int color) {
